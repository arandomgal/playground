...
/**
 * Use CountDownLatch to guarantee that all the child
 * threads are complete and then parent thread can move forward.
 ...
 */
public class ParentWaitForUnreliableChildThreads {
